...
async def on_ready(bot: discord.Bot):
    ...
    # on_ready é disparado a cada reconexão do gateway (não só na primeira vez).
    # Sem este controle, auto_update_loop e voice_sweep_loop seriam recriados
    # em cada reconexão, acumulando tasks em paralelo e causando OOM.
